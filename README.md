...
To build the final jar and optimize the jbandit application for production, run:
...
Then navigate to [http://localhost:15876](http://localhost:15876) in your browser.
